 ...
 * @author haris
 */
public class FormPelangganFrame extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FormPelangganFrame.class.getName());
    private boolean isEdit = false;
    
    /**
     * Creates new form FormPelangganFrame
     */
    public FormPelangganFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FormPelangganFrame().setVisible(true));
    }
