 ...
 * @author haris
 */
public class MekanikFrame extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MekanikFrame.class.getName());

    /**
     * Creates new form MekanikFrame
     */
    public MekanikFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MekanikFrame().setVisible(true));
    }
